...
class ADD_CAMERA_RIGS_MT_composition_guides_menu(Menu):
    ...
    def draw(self, context):
        ...
        layout.proop(cam, "show_composition_center")
        ...
        layout.prop(cam, "show_composition_golden_tri_b")
    ...
    layout = self.layout
    layout.menu(CustoMenu.bl_idname)

    def register():
        bpy.utils.register_class(AND_CAMERA_RIGS_MT_composition_guides_menu)
